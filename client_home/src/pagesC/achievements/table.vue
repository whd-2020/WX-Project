<template>
  <view class="page_diy_table page_achievements_table" :style="{ paddingTop: vuex_custom_bar_height + 'px' }">
        ...
        <view v-for="(o, i) in list" :key="i" class="list-item">
          ...
          <view class="operate-bar">
            <view width="100%" class="me-btn btn-delete" @click="delInfo(i)"
                  v-if="$check_action('/achievements/table', 'del') || $check_action('/achievements/view', 'del')">
              删除
            </view>
            <view width="100%" class="me-btn btn-info" @click="$navTo('/pagesC/achievements/view?' + field + '=' + o[field])"
