		...
		<el-row class="row_ce"> 
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="玩家网名" prop="player_screen_name">
												<el-input id="player_screen_name" v-model="form_sub['player_screen_name']" placeholder="请输入玩家网名"
							  v-if="(form_sub['gamer_id'] && $check_field('set','player_screen_name')) || (!form_sub['gamer_id'] && $check_field('add','player_screen_name'))"></el-input>
					<div v-else-if="$check_field('get','player_screen_name')">{{form_sub['player_screen_name']}}</div>
											</el-form-item>
			</el-col>
								<el-col v-if="$check_field('get','gold_coin_balance') || $check_field('add','gold_coin_balance') || $check_field('set','gold_coin_balance')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="金币余额" prop="gold_coin_balance">
								<el-input-number id="gold_coin_balance" v-model.number="form_sub['gold_coin_balance']"
						v-if="(form_sub['gamer_id'] && $check_field('set','gold_coin_balance')) || (!form_sub['gamer_id'] && $check_field('add','gold_coin_balance'))"></el-input-number>
					<div v-else-if="$check_field('get','gold_coin_balance')">{{form_sub['gold_coin_balance']}}</div>
							</el-form-item>
			</el-col>
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
				<el-form-item v-if="$check_action('/gamer/view','set') || $check_action('/gamer/view','add')">
