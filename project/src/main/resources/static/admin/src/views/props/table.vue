	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button v-if="$check_action('/props/table','del') || $check_action('/props/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
				...
				<el-table-column prop="prop_name" @sort-change="$sortChange" label="道具名称" 				v-if="$check_field('get','prop_name')" min-width="200">
					...
					<el-image style="width: 100px; height: 100px" :src="$fullUrl(scope.row['props_picture'])"
						:preview-src-list="[$fullUrl(scope.row['props_picture'])]">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/props/table','set') || $check_action('/props/view','set') || $check_action('/props/view','get') 
						|| $check_action('/purchase_record/table','add') || $check_action('/purchase_record/view','add') 
						" >
