	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button v-if="$check_action('/gamer/table','add') || $check_action('/gamer/view','add')" @click="$router.push('./view?')">添加</el-button>

						

						<el-button v-if="$check_action('/gamer/table','del') || $check_action('/gamer/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
			...
			<el-table-column prop="username" label="用户名" width="120">
				...
				<el-table-column fixed prop="nickname" label="昵称">
					...
					<el-table-column prop="gold_coin_balance" @sort-change="$sortChange" label="金币余额" 				v-if="$check_field('get','gold_coin_balance')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/gamer/table','set') || $check_action('/gamer/view','set') || $check_action('/gamer/view','get') 
						" >
